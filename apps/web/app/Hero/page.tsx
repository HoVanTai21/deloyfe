...
export default function Hero() {
  return (
    <div className="bg-sky-700 rounded-2xl shadow-sm shadow-sky-500">
      <div className="group hover:rotate-12 origin-bottom-right duration-500 cursor-pointer group-hover:duration-500 overflow-hidden relative  rounded-2xl shadow-inner shadow-gray-50 flex flex-col justify-around items-center w-40 h-80 bg-neutral-900 text-gray-50">
